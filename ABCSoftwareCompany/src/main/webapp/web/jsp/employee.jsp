<%-- 
    Document   : employee
    Created on : Aug 13, 2017, 8:46:34 AM
    Author     : thamira
--%>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box" >
                            ...
                            <div class="form-bottom">
                                <form role="form" action="addemployee" method="post" class="Employee-form" id="Employee-form">

                                    <div class="form-group">
                                        <label class="sr-only" for="formemployeefirstname">Employee First Name</label>
                                        <input type="text" name="formemployeefirstname" placeholder="Employee First Name..." class="formemployeefirstname form-control" id="formemployeefirstname">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="formemployeelastname">Employee Last Name</label>
                                        <input type="text" name="formemployeelastname" placeholder="Employee Last Name..." class="formemployeelastname form-control" id="formemployeelastname">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="sr-only" for="formemployeephone">Phone</label>
                                        <input type="text" name="formemployeephone" placeholder="Employee phone..." class="formemployeephone form-control" id="formemployeephone">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="formemployeeaddress">Address</label>
                                        <input type="text" name="formemployeeaddress" placeholder="Employee Address..." class="formemployeeaddress form-control" id="formemployeeaddress">
                                    </div>
                    
                                     <div class="form-group">
                                        <label class="sr-only" for="formStatus">Status</label>
                                        <select name="employeepossition" id="formStatus" class="formStatus form-control">
                                            <option value="">Employee possition...</option>
