                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-body">
                                                <table id="example2" class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            List<Project> allProject = (List<Project>) request.getAttribute("projectList");
                                                            ...
                                                            for (Project project : allProject) {
                                                                out.println("<tr>\n"
                                                                        ...
                                                                        + " <td>" + project.getLavel() + "</td>\n"
                                                                        + " <td>" + project.getStatus() + "</td>\n"
                                                                        + "<td>\n"
                                                                        + "<form role=\"form\" action=\"editproject\" method=\"post\" class=\"login-form\" id=\"login-form\">\n"
                                                                        ...
                                                                        + " </td>"
                                                                        + "<td>\n"
                                                                        + "<form role=\"form\" action=\"assignemployee\" method=\"post\" class=\"login-form\" id=\"login-form\">\n"
                                                                        + "<input type=\"hidden\" name=\"id\" value=\'" + project.getProjectId() + "\'>\n"
                                                                        + "\n"
                                                                        + "<p data-placement=\"top\" data-toggle=\"tooltip\" title=\"Delete\">\n"
                                                                        + "<button type=\"submit\" class=\"btn btn-primary btn-xs\" data-title=\"Delete\" data-toggle=\"modal\"  >\n"
                                                                        ...
                                                                        + " </td>"
                                                                        + "<td>\n"
                                                                        + "<form role=\"form\" action=\"deleteproject\" method=\"post\" class=\"login-form\" id=\"login-form\">\n"
                                                                        + "<input type=\"hidden\" name=\"id\" value=\'" + project.getProjectId() + "\'>\n"
                                                                        + "\n"
                                                                        + "<p data-placement=\"top\" data-toggle=\"tooltip\" title=\"Delete\">\n"
