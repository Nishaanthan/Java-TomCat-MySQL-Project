                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-body">
                                                <table id="example2" class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            List<Employee> allEmployee = (List<Employee>) request.getAttribute("listEmployee");
                                                            ...
                                                            for (Employee employee : allEmployee) {
                                                                out.println("<tr>\n"
                                                                        ...
                                                                        + "<td>\n"
                                                                        + "<form role=\"form\" action=\"editemployee\" method=\"post\" class=\"login-form\" id=\"login-form\">\n"
                                                                        ...
                                                                        + " </td>"
                                                                        + "<td>\n"
                                                                        + "<form role=\"form\" action=\"deleteemployee\" method=\"post\" class=\"login-form\" id=\"login-form\">\n"
                                                                        + "<input type=\"hidden\" name=\"id\" value=\'" + employee.getEmpId() + "\'>\n"
                                                                        + "\n"
