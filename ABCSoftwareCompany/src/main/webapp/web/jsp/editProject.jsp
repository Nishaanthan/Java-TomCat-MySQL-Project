<%-- 
    ...
    Created on : Aug 13, 2017, 12:11:13 AM
    Author     : thamira
--%>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                                <form role="form" action="SubmitEditProject" method="post" class="project-form" id="project-form">
                                    <input type="hidden" value="<%=project.getProjectId()%>" name="id">
                                    <div class="form-group">
                                        <label class="sr-only" for="formname">Project Name</label>
                                        <input value="<%=project.getName()%>" type="text" name="formname" placeholder="Project Name..." class="formname form-control" id="formname">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="formClientName" id="formClientName" class="formClientName form-control">
                                            <option value="<%=project.getClient_id()%>"><%=project.getClient().getName()%></option>
                                            <%
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="formLevel" id="formLevel" class="formLevel form-control">
                                           <option value="<%=project.getLavel()%>"><%=project.getLavel()%></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="formStatus" id="formStatus" class="formStatus form-control">
                                            <option value="<%=project.getStatus()%>"><%=project.getStatus()%></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<%=simpDate.format(project.getStartDate())%>" type="text" name="formStartDate" placeholder="Project Start Date..." class="formStartDate form-control" id="formStartDate">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="formEndDate">End Day</label>
                                        <input value="<%=simpDate.format(project.getEndDate())%>" type="text" name="formEndDate" placeholder="Project End Date..." class="formEndDate form-control" id="formEndDate">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="formdescription">Description</label>

                                        <input value="<%=project.getDescription()%>" type="text"  name="formdescription" placeholder="Project Description..." class="formdescription form-control" id="formdescription">
