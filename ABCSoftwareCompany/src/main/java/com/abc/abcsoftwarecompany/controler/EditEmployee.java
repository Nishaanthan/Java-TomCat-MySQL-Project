...
public class EditEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Employee findEmployeeById = employeeRepository.findEmployeeById(new Long(id));
            request.setAttribute("editemployee", findEmployeeById);
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/web/jsp/editemployee.jsp");
