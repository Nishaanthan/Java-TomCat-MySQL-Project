 ...
 * @author thamira
 */
@WebServlet(name = "SubmitEditEmployee", urlPatterns = {"/submiteditemployee"})
public class SubmitEditEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            employeeRepository.upadate(new com.abc.abcsoftwarecompany.model.Employee(employeepossition, formemployeephone, formemployeeaddress, formemployeefirstname, formemployeelastname),new Long(id));
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SubmitEditEmployee</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SubmitEditEmployee at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(SubmitEditEmployee.class.getName()).log(Level.SEVERE, null, ex);
