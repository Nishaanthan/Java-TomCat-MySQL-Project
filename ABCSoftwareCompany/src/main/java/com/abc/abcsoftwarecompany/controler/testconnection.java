...
import com.abc.abcsoftwarecompany.repository.repositoryimpl.RoleRepositoryImpl;
...
public class testconnection extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Thamira testconnection</title>");
            out.println("</head>");
            out.println("<body>");
...
//            userRepositoryImpl.save(new User("maduka@gmail.com", "maduka", "19998"));
            RoleRepository role = new RoleRepositoryImpl();
//            role.save(new Role("Admin"));
            User findUserByUserName = userRepositoryImpl.findUserByUserName("thamira");
            System.out.println(findUserByUserName.getId());
            Role findRoleByRoleName = role.findRoleByRoleName("Admin");
            System.out.println(findRoleByRoleName.getId());
            UserRoleRepository userRole = new UserRoleRepositoryImpl();
            userRole.save(new UserRole(findUserByUserName.getId(), findRoleByRoleName.getId()));
