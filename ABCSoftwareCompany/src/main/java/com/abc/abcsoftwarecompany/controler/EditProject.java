...
public class EditProject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Project project = projectRepository.findProjectByProjectId(new Long(id));
            
            
            ClientRepository clientRepository=new ClientRepositoryImpl();
            List<com.abc.abcsoftwarecompany.model.Client> findAll = clientRepository.findAll();
            Client findClientByClientId = clientRepository.findClientByClientId(project.getClient_id());
            
            project.setClient(findClientByClientId);
            request.setAttribute("project", project);
            request.setAttribute("clientList", findAll);
            
            
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/web/jsp/editProject.jsp");
