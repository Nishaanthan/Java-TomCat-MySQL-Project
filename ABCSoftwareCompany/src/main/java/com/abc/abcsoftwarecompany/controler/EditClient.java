...
public class EditClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ClientRepository client = new ClientRepositoryImpl();
            Client findClientByClientId = client.findClientByClientId(new Long(id));
            request.setAttribute("editclient", findClientByClientId);

            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/web/jsp/editclient.jsp");
