...
public class ProjectList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Project> allProject = projectRepository.getAllProject();    
            request.setAttribute("projectList", allProject);
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/web/jsp/dashbord.jsp");
